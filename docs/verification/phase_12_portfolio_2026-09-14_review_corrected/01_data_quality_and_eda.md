...
The two sensors share 2035 accepted hours (one observation from each sensor per hour). They are site-level records, not city averages. Missing periods stay visible: CMT8 has 3 missing run(s) with a longest gap of 3 h; OceanPark has 3 missing run(s) with a longest gap of 119 h.
...
| --- | --- | --- | --- |
| CMT8 | 0.810071 (2150) | -0.338661 (2034) | 2033 |
| OceanPark | 0.869412 (2033) | -0.310363 (1917) | 1916 |
...
Daily grid: 182 sensor-days, including partial and unqualified dates. Qualified means exist for 172 full 24-hour Vietnam-local sensor-days with at least 18 accepted hours. Unqualified daily means stay null in qualified charts.
