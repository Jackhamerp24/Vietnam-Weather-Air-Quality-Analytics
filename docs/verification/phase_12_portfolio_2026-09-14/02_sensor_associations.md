...
## Primary hypothesis family (pairwise_complete, log1p, 1-day blocks)

| Hypothesis | Question | n | Estimate | 95% interval | Adjusted p | Label |
| --- | --- | --- | --- | --- | --- | --- |
| H1 | Within-sensor PM2.5 vs wind speed (adjusted) | 3951 | -0.207759 | [-0.256867, -0.166087] | 0.001999 | inferential |
| H2 | Within-sensor PM2.5 vs relative humidity (adjusted) | 3951 | 0.0986223 | [-0.00576113, 0.186298] | 0.067966 | inferential |
| H3 | OceanPark minus CMT8 on shared accepted hours | 4070 | 0.179238 | [0.0596894, 0.296092] | 0.0029985 | exploratory |

Estimates are the adjusted change in log1p(PM2.5) per one analysis-window standard deviation of the exposure (H3: OceanPark minus CMT8). Holm adjustment covers H1 and H2; H1 remains significant at 0.05 and H2 does not. H3 is an unadjusted exploratory sensor contrast.
